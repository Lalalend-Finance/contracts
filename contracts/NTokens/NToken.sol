...
/**
 * @title Lalalend's NToken Contract
...
contract NToken is NTokenInterface, Exponential, TokenErrorReporter {
    ...
    function mintFresh(address minter, uint mintAmount) internal returns (uint, uint) {
         ...
         *  Note: The nToken must handle variations between ERC-20 and EVMOS underlying.
 ...
 /**
    ...
    function repayBorrowFresh(address payer, address borrower, uint repayAmount) internal returns (uint, uint) {
         ...
         *  Note: The nToken must handle variations between ERC-20 and BEVMOSNB underlying.
